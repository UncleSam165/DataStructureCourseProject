...
public:
	...
	void UpdateStatusBar(int CurrentTimeStep, double CH, ENMY_STATUS CS, 
		...
		int KilledCount, int KilledFighters, int KilledHealers, int KilledFreezers);	//prints info on status bar. Info includes timestep and other enemies info as illustrated in project doc
	void UpdateInterface(int CurrentTimeStep, double CH, ENMY_STATUS CS,
		int ActiveCount, int ActiveFighters, int ActiveHealers, int ActiveFreezers,
		int FrostedCount, int FrostedFighters, int FrostedHealers, int FrostedFreezers,
